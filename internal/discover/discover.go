...
func ProtocolExamples(agentName string) (modelFamilies string, examples string) {
	examplesMap := map[string]string{
		...
		"kimi":        "Kimi 原生 (Kimi K1, Kimi K2, Kimi-Max) + OpenAI/Anthropic/DeepSeek/Glm 等（通过代理路由）",
		"hermes":      "Nous Hermes 原生 (Hermes 2, Hermes 3) + OpenAI/Anthropic/DeepSeek/Glm 等（通过代理路由）",
		"kiro":        "Kiro 原生模型 + OpenAI/Anthropic/DeepSeek/Glm 等（通过代理路由）",
		"grok":        "xAI Grok 原生 (Grok 2, Grok 3) + OpenAI/Anthropic/DeepSeek/Glm 等（通过代理路由）",
		"qoder":       "Qoder 原生模型 + OpenAI/Anthropic/DeepSeek/Glm 等（通过代理路由）",
		"trae":        "字节跳动 Trae 原生 (Trae-Plus, Trae-Code) + OpenAI/Anthropic/DeepSeek/Glm 等（通过代理路由）",
