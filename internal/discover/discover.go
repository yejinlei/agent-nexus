...
func ProtocolExamples(agentName string) (modelFamilies string, examples string) {
	examplesMap := map[string]string{
		"codex":       "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, glm-5, 等真实模型)",
		"claude":      "OpenAI/Anthropic (claude-sonnet, claude-3.5, claude-4, gpt-4o, o1, deepseek-v4, 等真实模型)",
		"deepseek":    "OpenAI/Anthropic (deepseek-v4, deepseek-v4-flash, deepseek-coder, gpt-4o, o1, claude-sonnet, 等真实模型)",
		"opencode":    "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, 等真实模型)",
		"cursor":      "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, 等真实模型)",
		"openclaw":    "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, 等真实模型)",
		"openclaude":  "OpenAI/Anthropic (claude-sonnet, claude-3.5, gpt-4o, o1, deepseek-v4, 等真实模型)",
		"codebuddy":   "OpenAI/Anthropic (claude-sonnet, claude-3.5, gpt-4o, o1, deepseek-v4, 等真实模型)",
		"lmstudio":    "本地 LLM (通过 localhost 加载的任意模型，如 llama, qwen, mistral 等)",
		"clawx":       "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, 等真实模型)",
		"kimi":        "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, glm-5, 等真实模型)",
		"hermes":      "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, glm-5, 等真实模型)",
		"kiro":        "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, glm-5, 等真实模型)",
		"grok":        "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, glm-5, 等真实模型)",
		"qoder":       "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, glm-5, 等真实模型)",
		"trae":        "OpenAI/Anthropic (gpt-4, gpt-4o, o1, o3, claude-sonnet, claude-3.5, deepseek-v4, glm-5, 等真实模型)",
